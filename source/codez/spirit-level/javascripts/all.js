...
(function() {
  $(function() {
    var canvas, context, drawCircles, resizeCanvas, timeAtZero;
    window.app = {
      zeroColor: 'green',
    ...
    drawCircles = function(x, y, z, angle) {
      var additionalColor, centerX, centerY, contextRotationAngle, firstCircleCenterX, firstCircleCenterY, isZero, progressToZero, radius, secondCircleCenterX, secondCircleCenterY, x1, x2, xprime, y1, y2;
      ...
      isZero = ((((x1 === x2 && x2 === y1) && y1 === y2) && y2 === angle) && angle === 0);
      context.globalCompositeOperation = 'source-over';
      context.fillStyle = isZero ? window.app.zeroColor : 'black';
      ...
      context.fillStyle = isZero ? window.app.zeroColor : "white";
      context.fill();
      context.closePath();
      context.fillStyle = 'white';
      contextRotationAngle = Math.atan(y1 / x1) + (Math.PI / (x1 < 0 ? 2 : -2));
    ...
    $(window).on("deviceorientation", function(e) {
      ...
      return drawCircles(x, y, z, angleFromFlat);
    });
    if (window.orientation !== void 0) {
      ...
      return $("body").on("touchstart", function() {
        return false;
      });
    } else {
      return $("body").append("<div id='unsupported'>This device does not support orientation events. Sorry!</div>");
    }
  });
